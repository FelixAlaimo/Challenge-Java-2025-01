...
public class SellingPointController implements ISellingPointController {
    ...
    public ResponseEntity<List<SellingPointDTO>> getAllSellingPoints() {
        return ResponseEntity.ok(sellingPointService.findActiveSellingPointDTOs()); 
    }
	
	@GetMapping("/{sellingPointId}")
	@Transactional(readOnly = true)
	public ResponseEntity<SellingPointDTO> getSellingPoint(@PathVariable Long sellingPointId) {
		return ResponseEntity.ok(sellingPointService.findActiveSellingPointDTO(sellingPointId));
	}
	
	@PostMapping("/")
	@Transactional
	public ResponseEntity<String> createSellingPoint(@RequestBody SellingPointDTO sellingPointDTO) {
	...
	@PatchMapping("/")
	@Transactional
    public ResponseEntity<String> updateSellingPoint(@RequestBody SellingPointDTO sellingPointDTO) {
	...
	@Transactional
    public ResponseEntity<String> removeSellingPoint(@PathVariable Long sellingPointId) {
